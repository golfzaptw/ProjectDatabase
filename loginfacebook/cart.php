...
<button type="button" onclick="window.location.href='foods1.php'" class="btn btn-warning">เลือกสินค้าต่อ</button> 
...
if(!empty($_SESSION['cart']))
{
	...
	{
		$sql = "select * from type1 where id=$p_id";
...
</tbody></table><div align="right"><button class="button button5" type="button" name="Submit2" value="สั่งซื้อ" onclick="window.location='confirm.php';" >สั่งซื้อ</button></div>

...
if($status[$j] = true){
     ...
     if(isset($_SESSION['UserID'])){ echo '<a class="btn btn-warning" href="cart3.php?p_id='.$id[$j].'&act=add"> <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>เพิ่มในรถเข็น</a> ';}

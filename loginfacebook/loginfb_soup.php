...
<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="loginfb_boil.php">ประเภท:ต้ม</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="loginfb_fried.php">ประเภท:ทอด</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="loginfb_soup.php">ประเภท:แกง</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="loginfb_puff.php">ประเภท:ผัด</a></li>
          </ul>
        </li>

...
<br><br><br>
  <div>
      <H4> ทางร้านเลือกคัดสรรวัตถุดิบที่มีคุณภาพเพื่อคุณลูกค้าและราคาไม่แพงพร้อม ด้วยบริการส่งถึงที่ด้วยเวลาอันรวดเร็วทุกกล่องที่ส่งเราคัดสรรใส่ใจคุณภาพ </H4>
...
<br><br><br>
           <H4>ท่านสามารถชำระเงินปลายทางได้เมือสินค้าถึงมือท่านและเพลิดเพลินไปกับการสั่งอาหารภายในร้าน</H4>
...
<div class="row">
 ...
 <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p></p><br><br>
        <p><a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-primary" role="button">หิวคลิกเลย</a> </p>
      </div></div>
</div>

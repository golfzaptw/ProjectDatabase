	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='edittype1.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">แก้ไขข้อมูล <a class="btn btn-default" href="edittype1.php"> ดูรายการทั้งหมด </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <a class="btn btn-default" href="edittype1.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>

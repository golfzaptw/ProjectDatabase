...
<form action="phpMySQLEditRecordSave2.php?CusID=<?php echo $_GET["CusID"];?>" name="frmEdit" method="post">
<?php
$objConnect = mysql_connect("localhost","root","") or die("Error Connect to Database");
$objDB = mysql_select_db("admin");
$strSQL = "SELECT * FROM type2 WHERE name = '".$_GET["CusID"]."' ";
...
?>
<div class="content">
<center><H4>แก้ไขข้อมูลอาหารประเภท:ทอด</H4></center><br><br>

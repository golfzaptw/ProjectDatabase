...
<form action="phpMySQLEditRecordSave3.php?CusID=<?php echo $_GET["CusID"];?>" name="frmEdit" method="post">
<?php
$objConnect = mysql_connect("localhost","root","") or die("Error Connect to Database");
$objDB = mysql_select_db("admin");
$strSQL = "SELECT * FROM type3 WHERE name = '".$_GET["CusID"]."' ";
...
?>
<div class="content">
<center><H4>แก้ไขข้อมูลอาหารประเภท:แกง</H4></center><br><br>

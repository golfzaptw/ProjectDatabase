...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form4")) {
    ...
    if ( $upload_image->uploaded ) {
        ...
        $upload_image->process( "upload_images4" ); // เก็บภาพไว้ในโฟลเดอร์ที่ต้องการ  *** โฟลเดอร์ต้องมี permission 0777
        ...
        if ( $upload_image->processed ) {
            ...
            $insertSQL = sprintf("INSERT INTO tbl_image4 (image_name) VALUES ( '%s' )", $image_name );
            echo $insertSQL ;
